function [z_actual, z_modeled,x] = sutlej_spiti_capture_NOsed_trans(model_name, kf_input)
%% Input Variables
tic
close all
...
uplift(Spiti_Up) = 0.1e-3;%OrogenMin; %0.3e-3;
uplift(Spiti_LP) = 0.1e-3;%OrogenMin; %LeoPargilRate;
...
z_modeled = z;
save(['./output/' model_name '_final_spiti_profile.mat'],'-v7.3')
toc
end
