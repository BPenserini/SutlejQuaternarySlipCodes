...
%Redefine x_stds to match with model location
%x_stds = 430900;
...
ylim([z_actual(reach_indices(end))*0.9 z_actual(reach_indices(1))*1.1])
Font = 'Verdana';
AxisFontSize = 18; 

% Plot actual profile and STDS
plot(x./1000, z_actual,'-','Color',[0 0 0], 'LineWidth', 3)
